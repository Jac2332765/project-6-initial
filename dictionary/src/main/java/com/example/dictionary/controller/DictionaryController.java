...
public class DictionaryController {
    ...
    public List<Entry> getWordsStartingWith(@PathVariable String value) {
        ...
        long nanoSeconds = sw.getLastTaskTimeNanos();
        String message = new StringBuilder().append("Retrieved entries for word starting with [")
                .append(value)
                .append("] containing ")
                .append(entries.size())
                .append(" entries in ")
    ...
    public List<Entry> getWordsEndingWith(@PathVariable String value) {
        ...
        long nanoSeconds = sw.getLastTaskTimeNanos();
        String message = new StringBuilder().append("Retrieved entries for word ending with [")
                .append(value)
                .append("] containing ")
                .append(entries.size())
                .append(" entries in ")
